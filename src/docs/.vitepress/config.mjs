...
export default defineConfig({
    ...
    themeConfig: {
        ...
        //顶部导航配置
        nav: [
            { text: '指南', link: '/guide/what-is-codesandpit', activeMatch: '/guide/' },
            { text: '演示', link: '/examples/', activeMatch: '/examples/' },
            ...
            '/guide/': [
                {
                    text: '介绍',
                    items: [
                        { text: '是什么？', link: '/guide/what-is-codesandpit' },
        ...
        //社交链接配置
        socialLinks: [
            { icon: 'github', link: 'https://github.com/ajiho/codesandpit' },
        ],
        //页面底部的编辑此页面
        editLink: {
            pattern: 'https://github.com/ajiho/codesandpit/tree/main/src/docs/:path',
            text: '在github上编辑此页面'
        },
